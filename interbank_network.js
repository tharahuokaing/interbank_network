(() => {
    ...
    const NETWORK_BRIDGES = [
        { id: "NODE-BKG-01", name: "Bakong API Link", type: "Core Settlement", status: "Online", currency: "KHR / USD", liquidity: 2500000.00 },
        { id: "NODE-FST-02", name: "FAST Clearing Node", type: "Retail Routing", status: "Online", currency: "KHR", liquidity: 750000.00 },
        { id: "NODE-ISO-03", name: "Interbank ISO Gateway", type: "Cross-Border SWIFT", status: "Warning", currency: "USD / EUR", liquidity: 1200000.00 },
        { id: "NODE-NCH-04", name: "National Clearing House", type: "Batch Settlement", status: "Online", currency: "KHR / USD", liquidity: 3100000.00 },
        { id: "NODE-RTS-05", name: "Real-time Gross Settlement", type: "High-Value Processing", status: "Online", currency: "USD", liquidity: 8500000.00 },
        { id: "NODE-RMG-06", name: "Retail Mobile Gateway", type: "Peer-to-Peer Sweep", status: "Online", currency: "KHR / USD", liquidity: 450000.00 }
    ];
